...
class Model(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, graph=None, graph_args=dict(), in_channels=3):
        ...
        self.transformer_encoder_layer = TransformerEncoderLayer(d_model=256 * num_point + 256, nhead=8)
        self.transformer_encoder = TransformerEncoder(self.transformer_encoder_layer, num_layers=6)
        self.positional_encoding = self.generate_positional_encoding(256 * num_point + 256,  4000)  # Assuming T is the max sequence length
    ...
    def forward(self, x1,x2):
        ...
        # dimensionality of the input sequence is [N,T,3840+256]
        # add positioinal encoding if needed as the 2nd dimension represents the time axis (T) of the video frames
        # also add a mask to avoid the model to attend to the padding tokens

#  Transformer should comes here
